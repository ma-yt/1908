...
<body>
	<form action="{{url('/wenz/store')}}" method="post" enctype="multipart/form-data">
	@csrf
		<table>
			<tr>
				<td>文章标题</td>
			...
			<tr>
				<td>文章分类</td>
				<td>
					<input type="text" name="w_fl">
				</td>
			</tr>
			<tr>
				<td>文章重要性</td>
				<td>
					<input type="radio" name="w_zyx" value="1">普通
					<input type="radio" name="w_zyx" value="2">顶置
				</td>
			</tr>
			<tr>
				<td>是否显示</td>
				<td>
					<input type="radio" name="w_show" value="1">显示
					<input type="radio" name="w_show" value="2">不显示
				</td>
			</tr>
			<tr>
				<td>文章作者</td>
				<td>
					<input type="text" name="w_zuozhe">
			...
			<tr>
				<td>关键字</td>
				<td><input type="text" name="w_gjz"></td>
			</tr>
			<tr>
				<td>网页描述</td>
				<td><textarea width="" height="" name="w_desc"></textarea></td>
			</tr>
			<tr>
				<td>上传文件</td>
				<td><input type="file" name="w_img"></td>
			</tr>
			<tr>
				<td></td>
				<td>
